...
from src.app.internal.auth.dto import TokensDTO
from src.app.internal.auth.utils import convert_to_timestamp
...
class JWTAuth:
    ...
    def generate_tokens(self, subject: str, payload: dict[str, Any]) -> TokensDTO:
